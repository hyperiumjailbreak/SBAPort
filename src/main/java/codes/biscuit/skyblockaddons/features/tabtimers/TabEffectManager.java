...
public class TabEffectManager {
    ...
    public void updatePotionEffects() {
        ...
        IChatComponent tabFooterChatComponent;
        
        try {
            Field f = Minecraft.getMinecraft().ingameGUI.getTabList().getClass().getField("footer");
            f.setAccessible(true);
            tabFooterChatComponent = (IChatComponent) f.get(Minecraft.getMinecraft().ingameGUI.getTabList());
        } catch (NoSuchFieldException | IllegalArgumentException | IllegalAccessException e) {
            e.printStackTrace();
            tabFooterChatComponent = null;
        }
